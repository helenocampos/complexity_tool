...
public class DelegateTree<V, E> extends GraphDecorator<V, E> implements Tree<V, E> {
    ...
    /**
     * Creates a new <code>DelegateTree</code> which delegates to
     * <code>graph</code>. Assumes that <code>graph</code> is already a tree; if
     * it's not, future behavior of this instance is undefined.
     */
...
//			"Passed DirectedGraph must be empty");
     ...
     * @param edgeType must be EdgeType.DIRECTED or the underlying graph may
     * throw an exception
